    ...
    if (
        ...
        if configuration.optimize_tlu_based_on_measured_bounds:
            ...
            if bounds:
                ...
                offset_before_tlu = -bounds[0]
                new_bounds = [bounds[0] + offset_before_tlu, bounds[1] + offset_before_tlu]

                variable_input_dtype = Integer.that_can_represent(new_bounds)

                variable_input.properties["offset_before_tlu"] = offset_before_tlu
