        ...
        *args: Optional[Union[int, np.ndarray, List]],
        ...
        Args:
            *args (Optional[Union[int, np.ndarray, List]]):
            ...
            circuit_name (str):
                name of the circuit to encrypt
        ...
        ordered_sanitized_args = validate_input_args(self.specs, circuit_name=circuit_name, *args)

        self.keygen(force=False)
        keyset = self.keys._keyset  # pylint: disable=protected-access

        exporter = ValueExporter.new(keyset, self.specs.client_parameters, circuit_name)
        exported = [
            None
            if arg is None
            else Value(
        ...
        *results: Union[Value, Tuple[Value, ...]],
        ...
        Args:
            *results (Union[Value, Tuple[Value, ...]]):
            ...
            circuit_name (str):
                name of the circuit to decrypt for
        ...
        decrypter = ValueDecrypter.new(keyset, self.specs.client_parameters, circuit_name)
        decrypted = tuple(
