...
// Exceptions. See
// https://github.com/zama-ai/concrete-compiler/blob/main/LICENSE.txt
...
#  See https://github.com/zama-ai/concrete-compiler/blob/main/LICENSE.txt for license information.") || print_and_exit $file
done
